// beam_jni.c — JNI entry points for OrientDemo.
// Generated by mix mob.new. Edit the two defines below; do not touch the rest.

#include <jni.h>
#include "mob_beam.h"

#define BRIDGE_CLASS  "com/example/orient_demo/MobBridge"
#define APP_MODULE    "orient_demo"
...
Java_com_example_orient_1demo_MainActivity_nativeSetActivity(JNIEnv* env, jobject thiz, jobject activity) {
    mob_init_bridge(env, activity);
}

JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MainActivity_nativeStartBeam(JNIEnv* env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MainActivity_nativeNotifyOrientation(JNIEnv* env, jobject thiz, jstring orient) {
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendTap(JNIEnv* env, jclass cls, jint handle) {
    mob_send_tap((int)handle);
}

// Called from MobBridge.nativeSendChangeStr/Bool/Float when an input widget changes.
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendChangeStr(JNIEnv* env, jclass cls, jint handle, jstring value) {
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendChangeBool(JNIEnv* env, jclass cls, jint handle, jboolean value) {
    mob_send_change_bool((int)handle, (int)value);
}

JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendChangeFloat(JNIEnv* env, jclass cls, jint handle, jfloat value) {
    mob_send_change_float((int)handle, (double)value);
}

JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendFocus(JNIEnv* env, jclass cls, jint handle) {
    mob_send_focus((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendBlur(JNIEnv* env, jclass cls, jint handle) {
    mob_send_blur((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSendSubmit(JNIEnv* env, jclass cls, jint handle) {
    mob_send_submit((int)handle);
}

// Called from MobBridge.nativeHandleBack() when the Android back gesture fires.
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeHandleBack(JNIEnv* env, jclass cls) {
    mob_handle_back();
}
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeNotifyColorScheme(JNIEnv* env, jclass cls,
    jstring scheme) {
    if (!scheme) return;
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverAtom2(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverAtom3(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverMotion(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverFileResult(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverPushToken(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverNotification(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeSetLaunchNotification(JNIEnv* env, jclass cls,
    jstring json) {
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverWebViewMessage(JNIEnv* env, jclass cls,
    jlong pid, jstring json) {
    const char* cj = (*env)->GetStringUTFChars(env, json, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverWebViewBlocked(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverAlertAction(JNIEnv* env, jclass cls,
    jstring action) {
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverComponentEvent(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverVendorUsbDevices(JNIEnv* env, jclass cls,
    jlong pid, jstring json) {
    const char* cj = (*env)->GetStringUTFChars(env, json, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverVendorUsbPermission(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverVendorUsbOpened(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverVendorUsbData(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverVendorUsbWriteComplete(JNIEnv* env, jclass cls,
    jlong pid, jint session_id, jint bytes_written) {
    mob_deliver_vendor_usb_write_complete(pid, (int)session_id, (int)bytes_written);
}

JNIEXPORT void JNICALL
Java_com_example_orient_1demo_MobBridge_nativeDeliverVendorUsbEvent(JNIEnv* env, jclass cls,
