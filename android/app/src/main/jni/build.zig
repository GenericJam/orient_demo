// build.zig — Android native build for orient_demo.
//
...
//     Output: liborient_demo.so installed to
//     android/app/src/main/jniLibs/<abi>/liborient_demo.so so
