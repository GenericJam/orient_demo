defmodule OrientDemo.App do
  @moduledoc "Application entry point for OrientDemo."

  use Mob.App

  @impl Mob.App
  def navigation(_platform) do
    stack(:main, root: OrientDemo.HomeScreen)
  end
  ...
  def on_start do
    ...
    {:ok, _} = OrientDemo.Repo.start_link()
    Ecto.Migrator.with_repo(OrientDemo.Repo, fn repo ->
      Ecto.Migrator.run(repo, migrations_dir(), :up, all: true)
    end)

    Mob.Screen.start_root(OrientDemo.HomeScreen)
    Mob.Dist.ensure_started(node: :"orient_demo_android@127.0.0.1", cookie: :mob_secret)
  end
  ...
  defp migrations_dir do
    case System.get_env("MOB_BEAMS_DIR") do
      nil       -> Application.app_dir(:orient_demo, "priv/repo/migrations")
