%% orient_demo.erl — BEAM bootstrap for OrientDemo.
%% Called by the iOS/Android native launcher via -eval 'orient_demo:start().'.
...
start() ->
    ...
    step(5, fun() -> 'Elixir.OrientDemo.App':start() end),
